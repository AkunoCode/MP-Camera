...
class RoboflowClient:
    ...
    def __init__(self, api_url=None, api_key=None, workspace=None, workflow=None):
        ...
        self.workflow = workflow or os.getenv("ROBOFLOW_WORKFLOW", "detect-count-and-visualize-2")
    ...
    def run_workflow(self, image_path: str, use_cache: bool = True):
        ...
        if self._client is None:
            return {"error": "inference_sdk not installed or client initialization failed"}
        try:
